package com.checklist.test;

import com.checklist.google.api.Authorization;
...
public class GoogleDatastoreTest {
    ...
    public void connectionTest() {
        ...
        String datasetId = "quiet-dryad-788";
        ...
        try {
            ...
            datastore = DatastoreFactory.get().create(DatastoreHelper.getOptionsFromEnv()
                    .dataset(datasetId).credential(Authorization.getCredentials()).build());
        ...
        try {
            ...
            Key.Builder key = Key.newBuilder().addPathElement(
                    Key.PathElement.newBuilder()
                            .setKind("Reference").setId(5629499534213120l));
